  ...
  def clinic_history_params(step)
    permitted_attributes = case step
       ...
       when "b_antecedentes"
         ...
         [:neunatales, :neunatales_description, :patologicos, :patologicos_description, :quirurgicos, 
          ...
          :gestational_age, :eco, :fum, :pregnancy, :g, :p, :c, :a, :m, :v, :e]

       when "c_revision_sistemas"
         [:cardiovascular, :cardiovascular_description, 
          ...
          :skin_and_appendages_description]
